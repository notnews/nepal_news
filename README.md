...
There is no validated production extractor yet. The latest
[agreement and local Qwen pilot](experiments/layout/AGREEMENT.md) shows why
high detector overlap still needs semantic review.
